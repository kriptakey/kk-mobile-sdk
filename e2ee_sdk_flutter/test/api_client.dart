...
class ApiClient {
  ...
  //     Map<String, dynamic>? certificateRequestData, String deviceId) async {
  //   final serverUrl = cacheParameter.getServerIpAddress();
  //   final serverPort = cacheParameter.getServerPort();

  //   try {
  //     Response response =
  //         await _dio.post('http://$serverUrl:$serverPort/mobile/certSign',
  //             data: certificateRequestData,
  //             options: Options(headers: {
  //               'content-type': 'application/json',
  //               'Access-Control-Allow-Origin':
  //                   'http://$serverUrl:$serverPort/mobile/certSign',
  //               'device_id': deviceId,
  //             }));
  //     return response.data;
  //   } on DioException catch (e) {
